...
@inline _extend_number_to_symmetric_interval(z::Real) = -z..z
@inline _extend_number_to_symmetric_interval(z::AbstractInterval) = z
...
@inline _in_angular_interval_closed(α::T, α_int::Nothing) where {T<:Real} = true
@inline _in_angular_interval_closed(α::T, α_int::Nothing, tol::Real) where {T<:Real} = true
